                        ...
                        {posteds && posteds.map((post) => (
                            <a key={post.post_id} id={post.post_id} className="group">
                                ...
                                <div className="inline">
                                    ...
                                    <svg onClick={() => { Delete(post.post_id) }} style={{ display: 'inline-block' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
